...
class Particle {
    constructor(x, y, hu, firework, figure='default') {
      ...
      this.figure = figure;
      if (this.firework) {
        this.vel = createVector(0, random(-18, -14));
      } else {
        this.vel = this.getVelocityVector(this.figure);
